...
public class Dissoundtutor : MonoBehaviour
{
    ...
    public void Checkbtn(bool l1ck)
    {
        enableb = l1ck;
    }
    ...
    private void Update()
    {
        if (Input.GetKeyDown(KeyCode.Q) && ckfinish == 0 && enableb == true || CheckDisSound() && ckfinish == 0 && enableb == true)
        {
